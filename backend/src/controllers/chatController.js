...
4. Use neat, structured plain-text formatting with line breaks for lists. Do NOT use markdown formatting symbols (do NOT use asterisks ** for bold or * for bullet points) since the UI renders raw text. Use clear spacing, line breaks, and simple text indentation for lists and headings instead.
